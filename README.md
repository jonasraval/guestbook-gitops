...
│   ├── 🌐 Domain: guestbook-jonas.duckdns.org
│   ├── 🔄 Auto-renewal: Yes
...
```
1. 🌐 User visits https://guestbook-jonas.duckdns.org/
...
- DNS record pointing `guestbook-jonas.duckdns.org` to your cluster
...
2. **Update Repository Name in kustomization.yaml**:
   ...
   # Change: ghcr.io/jonasraval/guestbook-gitops
   ```
